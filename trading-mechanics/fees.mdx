...
<Tabs>
  ...
  <Tab title="30x to 40x Leverage">
    Using leverage between 30x-40x incurs a fee of **5 basis points**.
    <Accordion title="Fee Calculation">
      - **Leverage:** `35x`
      - **Fee Rate:** `5` basis points or `(0.05%)`
      - **Collateral:** `$100`
      - **Position Size**: `$3500`
      - **Fee:** `$1.75`
    </Accordion>
  ...
  <Tab title="Over 40x Leverage">
    Using leverage over 40x incurs a fee of **2 basis points**.
    <Accordion title="Fee Calculation">
      - **Leverage:** `50x`
      - **Fee Rate:** `2` basis points or `(0.02%)`
      - **Collateral:** `$100`
      - **Position Size**: `$5000`
      - **Fee:** `$1`
    </Accordion>
